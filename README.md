...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ----------- | -------- |  -------- |----|  :------------------------------------------------------------------------------------------------------------------------ |
|[Curso Python Básico](https://solyd.com.br/treinamentos/python-basico/) | Curso | Sim | PT-BR|  :white_check_mark:|	![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54)|Curso da linguagem de programação Python e lógica de programação para iniciantes.|
...
|[Curso Java Básico - Loiane Groner](https://loiane.training/curso/java-basico)|Curso |Sim |PT-BR|✅|	![Java](https://img.shields.io/badge/java-%23ED8B00.svg?style=for-the-badge&logo=java&logoColor=white)|Java Básico e Orientação à Objetos.
