...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ----------- | -------- |  -------- |----|  :------------------------------------------------------------------------------------------------------------------------ |
|[Curso de C# / .NET Para Iniciantes](https://www.youtube.com/playlist?list=PLkhtU8XJLj-5q4fcgUkjmrICOqWsgWNJr) | Curso | Não | PT-BR | :white_check_mark: |	![C#](https://img.shields.io/badge/C%23%20%2F%20.NET-512BD4?style=for-the-badge&logo=csharp&logoColor=white) | Curso da linguagem de programação C# para iniciantes. |
